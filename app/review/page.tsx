  ...
  return (
    <>
      ...
      <main className="flex-1 flex flex-col md:flex-row h-[calc(100vh-64px)] overflow-hidden bg-[#09090B] p-4 gap-4">
        ...
        <section className="hidden md:flex flex-1 bg-[#141417] border border-white/10 rounded-[32px] flex-col relative overflow-hidden">
          <div className="bg-white/5 border-b border-white/10 text-white px-6 py-4 flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs font-bold uppercase tracking-widest text-white/80">FACTURA_TRANSPORTE_00283.PDF</span>
            </div>
            ...
            <div className="bg-white shadow-2xl w-full max-w-2xl aspect-[1/1.41] p-8 flex flex-col gap-6 border border-outline text-[#191c1e]">
              <div className="flex justify-between items-start border-b border-gray-200 pb-4">
                ...
                <div className="text-right">
                  ...
                  <p className="text-gray-400">N° 0001-00002834</p>
                </div>
              </div>
              ...
              <div className="flex justify-end pt-4">
                <div className="w-1/2 space-y-2">
                  ...
                  <div className="flex justify-between border-t border-gray-300 pt-2"><span className="font-bold">TOTAL:</span><span className="font-bold font-mono text-[13px]">$559.625,00</span></div>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Data Review Form Section (Right) */}
            ...
            <div className="space-y-4 relative z-10">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col gap-2 group">
                  ...
                  <input className="bg-white/5 border border-white/10 p-3 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm w-full transition-all group-focus-within:bg-white/10 outline-none text-white color-scheme-dark" id="fecha" type="date" defaultValue="2023-10-25" />
                </div>
                <div className="flex flex-col gap-2 group">
                  <label className="text-[12px] font-semibold text-white/60" htmlFor="nro_factura">Número de Factura</label>
                  <input className="bg-white/5 border border-white/10 p-3 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 font-mono text-sm w-full transition-all group-focus-within:bg-white/10 outline-none text-white" id="nro_factura" type="text" defaultValue="0001-00002834" />
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4 pt-6 border-t border-white/10 relative z-10">
              ...
              <div className="flex flex-col gap-2 group">
                ...
                <div className="relative transition-all group-focus-within:bg-white/10 rounded-xl">
                  <input className="bg-white/5 border border-white/10 p-3 pr-10 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm w-full outline-none text-white" id="proveedor" type="text" defaultValue="Logística del Sur S.A." />
