      ...
      <main className="flex-grow flex items-center justify-center p-6 relative overflow-hidden bg-background">
        <div className="max-w-5xl w-full z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-white/40 max-w-2xl mx-auto">Acceda a las herramientas de gestión documental y control de flota.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 h-[400px]">
            <Link href="/upload" className="group relative bg-[#141417] border border-white/10 rounded-[32px] overflow-hidden flex flex-col items-center justify-center p-8 hover:border-primary focus:ring-2 focus:ring-primary outline-none transition-all duration-300">
              ...
              <h2 className="text-3xl font-light text-white mb-2">Cargar <span className="font-semibold">Gastos</span></h2>
              <p className="text-sm text-white/60 text-center max-w-xs">Cargue manifiestos, facturas y documentos de carga para su procesamiento.</p>
            ...
            <Link href="/me" className="group relative bg-[#141417] border border-white/10 rounded-[32px] overflow-hidden flex flex-col items-center justify-center p-8 hover:border-primary focus:ring-2 focus:ring-primary outline-none transition-all duration-300">
              <div className="absolute top-0 right-0 w-64 h-64 bg-indigo-600/10 blur-[100px] pointer-events-none"></div>
              <div className="mb-6 w-16 h-16 bg-white/5 rounded-2xl flex items-center justify-center text-indigo-500 transition-transform duration-500 group-hover:scale-110">
                <FileText className="w-8 h-8" />
              </div>
              <h2 className="text-3xl font-light text-white mb-2">Mis <span className="font-semibold">Documentos</span></h2>
              <p className="text-sm text-white/60 text-center max-w-xs">Consulte, revise y gestione los documentos cargados previamente.</p>
              <div className="mt-8 flex items-center gap-2 text-indigo-400 font-semibold bg-white/5 px-4 py-2 rounded-full">
